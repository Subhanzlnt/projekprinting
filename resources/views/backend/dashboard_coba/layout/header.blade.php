{{-- <header class="navbar navbar-dark sticky-top bg-primary flex-md-nowrap p-0 shadow">
    <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">Minumint</a>
                ...
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    ...
                    <ul class="list-unstyled p-1">
                        ...
                        <form action="/logout" method="post">
                            @csrf
                            <li class="dropdown-item py-2 d-grid gap-2">
                                {{-- <a href="javascript:;" class="text-body ms-0">
                                <i class="me-2 icon-md" data-feather="log-out"></i>
                                <span>Log Out</span>
                            </a> --}}

                                <button type="submit" class="text-body nav-link p-0 m-0 border-0 text-start" style="background-color: transparent">
                                    <span data-feather="log-out" class="me-2 icon-md ">
